...
- ✅ إدارة محتوى المتجر (العنوان، الوصف، المزايا، الأسئلة الشائعة) من صفحة الكتب
- ✅ إدارة كاملة للفوتر (الوصف، التواصل الاجتماعي، أعمدة الروابط، الروابط السفلية) مع إخفاء تلقائي للروابط المرتبطة بصفحات مخفية
