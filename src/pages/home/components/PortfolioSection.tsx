...
import { defaultHomeSections, mergeHomeSections, type PortfolioTexts } from "@/lib/homeSections";
...
const PortfolioSection = () => {
  ...
  const [texts, setTexts] = useState<PortfolioTexts>(defaultHomeSections.portfolio);
    ...
    const fetchPortfolio = async () => {
      try {
        ...
        if (settingsRes.data?.home_sections) {
          setTexts(mergeHomeSections(settingsRes.data.home_sections).portfolio);
        }
      } catch (err: any) {
