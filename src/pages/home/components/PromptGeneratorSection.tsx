...
import { defaultHomeSections, mergeHomeSections, type PromptsTexts } from "@/lib/homeSections";
...
const PromptGeneratorSection = () => {
  ...
  const [texts, setTexts] = useState<PromptsTexts>(defaultHomeSections.prompts);
    ...
    supabase
      ...
      .then(({ data }) => {
        if (data?.home_sections) {
          setTexts(mergeHomeSections(data.home_sections).prompts);
        }
      })
      .catch(() => {});
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-blue-600 text-sm font-semibold tracking-wider uppercase">{texts.badge}</span>
            <div className="w-8 h-0.5 bg-blue-500"></div>
          </div>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#0d1b2e] leading-tight mb-4">
            {texts.title}{" "}
            <span className="text-blue-600">{texts.highlight}</span>
          </h2>
            ...
            {!generated ? (
              <div className="flex-1 bg-white rounded-3xl border border-gray-100 flex flex-col items-center justify-center p-12 text-center">
                <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-4">
                  <i className="ri-sparkling-2-line text-blue-400 text-3xl"></i>
                </div>
