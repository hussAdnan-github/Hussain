...
const HomePage = () => {
  ...
  useEffect(() => {
    supabase
      .from("site_settings")
      .select("whatsapp_number, show_blog, show_books, show_portfolio, show_services, show_prompts, show_prompt_generator")
      .eq("id", 1)
      .maybeSingle()
      .then(({ data }) => {
        if (data) {
  ...
  return (
    <div className="min-h-screen font-sans" style={{ fontFamily: "'Cairo', sans-serif" }}>
      ...
      {toggles.show_prompt_generator && <PromptGeneratorSection />}
