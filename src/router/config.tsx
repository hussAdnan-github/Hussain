...
import DashboardFooterPage from "../pages/dashboard/footer/page";
import DashboardContactPage from "../pages/dashboard/contact/page";
...
const dashboardRoutes: RouteObject[] = [
  ...
  { path: "/dashboard/footer", element: <AuthGuard><DashboardFooterPage /></AuthGuard> },
  { path: "/dashboard/contact", element: <AuthGuard><DashboardContactPage /></AuthGuard> },
